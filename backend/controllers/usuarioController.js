...
module.exports = {
    ...
    updateUsuario: async (req, res) => {
        try {
            ...
            res.status(500).json({ error, message: 'Error interno actualizando usuario' });
        }
    },
    ...
    getUsuario: async (req, res) => {
        try {
            ...
            res.status(500).json({ error, message: 'Error interno obteniendo usuarios' });
        }
    },
    ...
    getUsuarioById: async (req, res) => {
        try {
            ...
            res.status(500).json({ error, message: 'Error interno obteniendo usuario' });
        }
    },
    ...
    softDeleteUsuario: async (req, res) => {
        try {
            ...
            res.status(500).json({ error, message: 'Error interno eliminando usuario' });
        }
    },
